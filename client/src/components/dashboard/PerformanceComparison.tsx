...
export default function PerformanceComparison() {
    ...
    return (
      <Card className="p-6 bg-[#0B110B]/50 border-[#235317]/30 col-span-2">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#B8C2B8] mt-1">Rentabilidade acumulada (%)</p>
        </div>
        <div className="flex flex-col items-center justify-center h-80 text-center">
          ...
          <p className="text-[#6B756B] text-sm mt-1">Execute trades para ver sua performance</p>
        </div>
      </Card>
    );
  }
  ...
  return (
    <Card className="p-6 bg-[#0B110B]/50 border-[#235317]/30 col-span-2">
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-white">Sua Performance</h3>
        <p className="text-sm text-[#B8C2B8] mt-1">Rentabilidade acumulada (%) - Últimos 30 dias</p>
      </div>
      ...
      <div className="mt-4 p-4 bg-[#141C14]/30 rounded-lg border border-[#235317]/35">
