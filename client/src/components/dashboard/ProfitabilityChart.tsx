    ...
    return (
      <Card className="p-6 bg-[#0B110B]/50 border-[#235317]/30 col-span-2">
        <div className="mb-6">
          ...
          <p className="text-sm text-[#B8C2B8] mt-1">Performance semanal</p>
        </div>
        <div className="flex flex-col items-center justify-center h-80 text-center">
          <BarChart3 className="w-12 h-12 text-[#6B756B] mb-4" />
          <p className="text-[#B8C2B8] font-medium">Nenhum dado disponível</p>
          <p className="text-[#6B756B] text-sm mt-1">Execute trades para ver o gráfico de performance</p>
        </div>
      </Card>
    );
  }
